...
from NumericalMethods import PDF, args, Simpson, Probability
#endregion
...
def main():
    ...
    #following code calculates probability based off of probability function and user inputs
    probabilityx= Probability(PDF, args, c,GT)

    print(f"P(x{'>' if GT else '<'}{c:.2f}|N({mean},{stDev}))={probabilityx:.2f}")
    #endregion
#endregion
